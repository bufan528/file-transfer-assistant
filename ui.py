...
class UI:
    def __init__(self, page: ft.Page, storage, file_handler):
        ...
        self.type_config = {
            "text": {"icon": ft.icons.NOTES, "color": ft.colors.BLUE, "bg_color": ft.colors.BLUE_50, "label": "Text"},
            "link": {"icon": ft.icons.LINK, "color": ft.colors.GREEN, "bg_color": ft.colors.GREEN_50, "label": "Link"},
            "file": {"icon": ft.icons.INSERT_DRIVE_FILE, "color": ft.colors.ORANGE, "bg_color": ft.colors.ORANGE_50, "label": "File"},
            "image": {"icon": ft.icons.IMAGE, "color": ft.colors.PURPLE, "bg_color": ft.colors.PURPLE_50, "label": "Image"}
        }
    ...
    def _setup_page(self):
        self.page.title = "File Transfer v1.1.0"
    ...
    def _create_main_content(self):
        ...
        self.empty_state = ft.Container(
            content=ft.Column([
                ...
                ft.Icon(ft.icons.INVENTORY_2_OUTLINED, size=100, color=self.colors["primary"].with_opacity(0.3)),
                ft.Container(height=20),
                ft.Text("No items yet", size=22, weight=ft.FontWeight.W_600, color=self.colors["text"]),
                ft.Container(height=8),
                ft.Text("Tap the + button to add your first item", size=14, color=self.colors["text_secondary"]),
                ft.Container(height=30),
                ft.ElevatedButton(
                    "Add Item", icon=ft.icons.ADD_CIRCLE_OUTLINE,
                    style=ft.ButtonStyle(bgcolor=self.colors["primary"], color=ft.colors.WHITE,
                        padding=ft.padding.symmetric(horizontal=30, vertical=15), shape=ft.RoundedRectangleBorder(radius=20)),
        ...
        self.main_content = ft.Stack([self.content_list, self.empty_state], expand=True)
    ...
    def _create_bottom_navigation(self):
        ...
        self.nav_items = [
            ft.NavigationBarItem(icon=item[0], label=item[1],
        ...
        self.bottom_nav = ft.NavigationBar(
            destinations=self.nav_items, selected_index=0,
            animation_duration=300,
            label_behavior=ft.NavigationBarLabelBehavior.ALWAYS_SHOW,
            on_change=self._on_nav_change,
            bgcolor=self.colors["surface"], elevation=8, height=70
        )
        self.page.add(self.bottom_nav)

    def _create_floating_action_button(self):
        self.fab = ft.FloatingActionButton(
            icon=ft.icons.ADD, bgcolor=self.colors["primary"], foreground_color=ft.colors.WHITE,
            elevation=6, shape=ft.RoundedRectangleBorder(radius=15),
            on_click=self._show_add_dialog, extended=True, text="Add New", width=140, height=50
        )
    ...
    def _create_add_dialog(self):
        ...
        self.text_input = ft.TextField(label="Enter your text", multiline=True, min_lines=4, max_lines=8,
            border_radius=12, focused_border_color=self.colors["primary"])
        
        self.link_input = ft.TextField(label="URL", keyboard_type=ft.KeyboardType.URL,
            prefix_icon=ft.icons.LINK, border_radius=12, focused_border_color=self.colors["primary"])
        
        self.link_title = ft.TextField(label="Title (optional)", prefix_icon=ft.icons.LABEL_OUTLINE,
            border_radius=12, focused_border_color=self.colors["primary"])
        
        self.selected_file_info = ft.Text("No file selected", size=13, color=self.colors["text_secondary"])
        self.selected_file_path = None
        
        self.select_file_btn = ft.ElevatedButton("Choose File", icon=ft.icons.FOLDER_OPEN,
            style=ft.ButtonStyle(bgcolor=self.colors["primary_light"], color=self.colors["primary"],
                shape=ft.RoundedRectangleBorder(radius=10)))
        
        self.tabs = ft.Tabs(selected_index=0, animation_length=200,
            tabs=[ft.Tab(text="Text", icon=ft.icons.NOTES), ft.Tab(text="Link", icon=ft.icons.LINK),
                  ft.Tab(text="File", icon=ft.icons.UPLOAD_FILE), ft.Tab(text="Image", icon=ft.icons.ADD_PHOTO_ALTERNATE)],
        ...
        self.add_dialog = ft.AlertDialog(
            modal=True,
            title=ft.Row([ft.Icon(ft.icons.ADD_BOX, size=26, color=self.colors["primary"]),
                ft.Text("Add New Item", size=18, weight=ft.FontWeight.W_600)], spacing=10),
            content=ft.Container(content=ft.Column([self.tabs, ft.Divider(), self.tab_content], spacing=0),
                width=420, height=480),
            actions=[
                ft.TextButton("Cancel", style=ft.ButtonStyle(color=self.colors["text_secondary"]), on_click=self._close_add_dialog),
                ft.ElevatedButton("Save", icon=ft.icons.CHECK,
                    style=ft.ButtonStyle(bgcolor=self.colors["primary"], color=ft.colors.WHITE,
                        padding=ft.padding.symmetric(horizontal=25, vertical=12), shape=ft.RoundedRectangleBorder(radius=10)),
    ...
    def _update_tab_content(self, index):
        ...
        if index == 0:
            self.tab_content.controls.append(ft.Container(content=self.text_input, padding=20))
        elif index == 1:
            ...
            self.tab_content.controls.append(ft.Container(
                content=ft.Column([self.selected_file_info, ft.Container(height=10), self.select_file_btn],
                    horizontal_alignment=ft.CrossAxisAlignment.START), padding=20))
        elif index == 3:
            self.tab_content.controls.append(ft.Container(
                content=ft.Column([ft.Icon(ft.icons.PHOTO_CAMERA_ALT_OUTLINED, size=60, color=self.colors["primary"].with_opacity(0.3)),
                    ft.Text("Image upload coming soon!", size=14, color=self.colors["text_secondary"])],
                    alignment=ft.MainAxisAlignment.CENTER, horizontal_alignment=ft.CrossAxisAlignment.CENTER),
    ...
    def _create_detail_dialog(self):
        ...
        self.detail_dialog = ft.AlertDialog(modal=True,
            ...
            content=ft.Container(content=ft.Column([ft.Divider(), self.detail_content], scroll=ft.ScrollMode.AUTO),
    ...
    def _create_delete_confirmation(self):
        self.delete_dialog = ft.AlertDialog(modal=True,
            title=ft.Row([ft.Icon(ft.icons.WARNING_AMBER_ROUNDED, size=26, color=ft.colors.AMBER_600),
                ft.Text("Confirm Delete", size=18, weight=ft.FontWeight.W_600)], spacing=10),
            content=ft.Text("Are you sure you want to delete this item?", size=14, color=self.colors["text_secondary"]),
            actions=[
                ft.TextButton("Cancel", on_click=lambda _: self.page.close(self.delete_dialog)),
                ft.ElevatedButton("Delete", icon=ft.icons.DELETE_FOREVER,
                    style=ft.ButtonStyle(bgcolor=self.colors["error"], color=ft.colors.WHITE, shape=ft.RoundedRectangleBorder(radius=10)),
    ...
    def _build_item_card(self, item, index):
        ...
        type_badge = ft.Container(
            content=ft.Row([ft.Icon(config["icon"], size=14, color=config["color"]),
                ft.Text(config["label"], size=11, weight=ft.FontWeight.W_600, color=config["color"])], spacing=4),
            bgcolor=config["bg_color"], padding=ft.padding.symmetric(horizontal=10, vertical=5),
        ...
        card = ft.Card(elevation=2, margin=ft.margin.only(bottom=5),
            child=ft.Container(
                content=ft.ListTile(
                    ...
                    trailing=ft.IconButton(icon=ft.icons.MORE_VERT, icon_color=self.colors["text_secondary"],
    ...
    def _get_preview_text(self, content, item_type):
        if not content:
            return "(empty)"
        if item_type == "link":
            ...
            filename = os.path.basename(content) if content else "Unknown"
            return filename

    def _show_item_options(self, item):
        try:
            ...
            self.options_dlg = ft.AlertDialog(
                title=ft.Text("Options"), content=options,
                actions=[ft.TextButton("Cancel", on_click=lambda _: self.page.close(self.options_dlg))],
                shape=ft.RoundedRectangleBorder(radius=16)
            )
            self.page.open(self.options_dlg)
        except Exception as e:
    ...
    def _show_add_dialog(self, e=None):
        try:
            ...
            self.selected_file_path = None
            self.selected_file_info.value = "No file selected"
            self.selected_file_info.color = self.colors["text_secondary"]
            self.page.open(self.add_dialog)
        except Exception as ex:
            print(f"Error add dialog: {ex}")

    def _close_add_dialog(self, e=None):
        try: self.page.close(self.add_dialog)
        except: pass
    ...
    def _save_item(self, e=None):
        try:
            ...
            self._toast(f"Error: {str(ex)}")

    def _show_detail(self, item):
        try:
            self.current_detail_item = item
            config = self.type_config.get(item.get("type", "text"), self.type_config["text"])
        ...
        try:
            if self.item_to_delete:
                ...
                if item_type in ["file", "image"] and content:
                    self.file_handler.delete_file(os.path.basename(content), item_type)
                    
                self.storage.delete_item(item_id)
                self._toast("Deleted!")
                self.load_items(self.current_filter)
                try: self.page.close(self.detail_dialog)
                except: pass
    ...
    def _on_nav_change(self, e):
        try:
            ...
            if 0 <= idx < len(self.nav_filters):
                self.load_items(self.nav_filters[idx])
        except Exception as ex:
    ...
    def _toast(self, message):
        try:
            self.page.show_snack_bar(ft.SnackBar(content=ft.Text(message, color=ft.colors.WHITE),
                bgcolor=self.colors["success"], duration=2000))
        except Exception as e:
            print(f"Toast error: {e}")

    def _show_error_screen(self, error_msg):
        self.page.add(ft.Container(
            content=ft.Column([ft.Icon(ft.icons.ERROR_OUTLINE, size=80, color=self.colors["error"]),
                ft.Text("Something went wrong", size=24, weight=ft.FontWeight.BOLD, color=self.colors["error"]),
                ft.Container(height=15), ft.Text(error_msg, size=14, color=self.colors["text_secondary"])],
                alignment=ft.MainAxisAlignment.CENTER, horizontal_alignment=ft.CrossAxisAlignment.CENTER, expand=True),
            alignment=ft.alignment.center, bgcolor=self.colors["surface"], expand=True))
